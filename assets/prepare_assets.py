...
def main():
    ...
    directory_path = "/app/val2014"  # Change this to your directory path
    url = f"http://{host}:8000/images"
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        futures = [
            executor.submit(upload_file, file_path, url, stats) for file_path in files
        ]
